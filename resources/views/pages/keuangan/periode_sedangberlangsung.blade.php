...
@section('content')
    ...
    <div class="main-content">
        <section class="section">
            <x-title_halaman title="Periode Sedang Berlangsung" />
            ...
            <div class="section-body">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <div class="add-items d-flex flex-row gap-3">
                                    <button type="button" class="add btn btn-primary mb-3" data-bs-toggle="modal"
                                        data-bs-target="#modalPembayaran">
                                        <i class="fas fa-plus"></i> Tambah Pembayaran
                                    </button>
                                    <button type="button" class="add btn btn-success mb-3" id="selesai">
                                        <i class="fas fa-calendar-check"></i> Tandai Periode Selesai
                                    </button>
                                </div>
                                    ...
                                    <table class="table table-bordered border-dark mt-2 mb-3 text-center align-middle"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="width: 15%;" class="text-center">Saldo Terakhir</th>
                                            </tr>
                                        </thead>
                                    </table>
                                </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#example').DataTable({
                ajax: {
                    type: "GET",
                    url: "/periode/sedang_berlangsung",
                    dataSrc: 'data',
                },
                columns: [{
                        data: null,
            ...
            $('#selesai').on('click', function() {
                Swal.fire({
                    ...
                    text: 'Periode bulan ini telah selesai.',
                    icon: 'warning',
                    ...
                    if (result.value == true) {
                        $.ajax({
                            ...
                            success: function(res) {
                                Swal.fire('Berhasil!', 'Periode ditandai selesai.',
                                    'success');
                                location.reload();
                            },
                            error: function() {
