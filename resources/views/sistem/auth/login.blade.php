...
<body class="bg-white">
                                ...
                                <form method="POST" action="" class="needs-validation" novalidate=""
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="username" type="text"
                                            class="form-control @if (session('msg')) is-invalid @endif"
                                    ...
                                    <div class="form-group">
                                        <div class="d-block">
                                            <label for="loginas"
                                                class="control-label">{{ __('Login Sebagai') }}</label>
                                        </div>
                                        <select name="" id="whichlogin" class="form-control">
    ...
    {{-- <script type="text/javascript">
        $(function() {
            $('#whichlogin').on('change', function() {
                let url = '';
                if (this.value == 'siswa') {
                    url = '{{ route('siswa.login.submit') }}';
                } else {
                    url = '{{ route('pengajar.login.submit') }}';
                }
