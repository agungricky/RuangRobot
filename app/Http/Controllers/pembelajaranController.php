    ...
    public function info_kepengguna($id)
    {
        ...
        foreach ($data_siswa as $item) {
            ...
            $response = Http::withHeaders([
                ...
                'message' => "
Halo 👋 $data->nama,
Selamat sudah bergabung dengan *Ruang Robot*!
    
Kamu sudah terdaftar dan bisa mengakses sistem ruangrobot.com dengan akun sebagai berikut:

▶ username : $username
▶ password : ruangrobot

Jika ada pertanyaaan atau membutuhkan bantuan, jangan ragu untuk menghubungi kami di : +6281272455577
